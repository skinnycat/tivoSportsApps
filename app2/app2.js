 ...
 * @author Neil Cooper
 *
 * @description - This is going to need a lot of re-factoring :-)
 */
...
var SportsApp = function () {
    ...
    vmDtvLib.dax.init("Sky Sports US Open Tennis (app2)", version);
    vmDtvLib.dax.startApp();
